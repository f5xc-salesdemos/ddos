...
:::caution[قائمة استكشاف الأخطاء وإصلاحها]
إذا لم يتم إنشاء جلسة BGP:
...
1. تحقق من `show ip bgp neighbors <IP>` لمعرفة آخر خطأ/سبب
   لإعادة التعيين.
1. على كل وحدة HA، تحقق من أن أنفاق الوحدة الخاصة بها تعمل وأن
   جيران BGP الخاصين بها مُكوَّنون (وليس أنفاق الوحدة الأخرى).
:::

### وحدة تحكم XC

انتقل إلى **خدمات DDoS والعبور >
[حماية DDoS > الرؤية](https://docs.cloud.f5.com/docs-v2/ddos-and-transit-services/how-tos/network-firewall/l3l4-ddos-mitigation)** لعرض:
