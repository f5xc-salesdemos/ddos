...
Les préfixes protégés **doivent être routables publiquement** (non-RFC 1918).
Les IP des points de terminaison externes GRE doivent également être routables publiquement lorsque les tunnels
traversent l'Internet public ; la connectivité privée (L2, peering
privé) peut autoriser des points de terminaison RFC 1918. Voir
...
centres de nettoyage géo-localisés (4 tunnels au total pour une paire HA).
:::
...
flowchart LR
    ...
    subgraph XC["F5 Distributed Cloud"]
        C1["xCENTER_1x Nettoyage<br/>xXC_C1_OUTER_V4x"]
        C2["xCENTER_2x Nettoyage<br/>xXC_C2_OUTER_V4x"]
    end

    subgraph DC["Centre de données xDC_NAMEx"]
        BIGIPA["BIG-IP-A<br/>xBIGIP_A_OUTER_V4x"]
        BIGIPB["BIG-IP-B<br/>xBIGIP_B_OUTER_V4x"]
        NET["Réseau protégé DDoS<br/>xPROTECTED_PREFIX_V4x<br/>xPROTECTED_PREFIX_V6x<br/><i>Votre bloc d'IP publiques</i>"]
    end
...
routables publiquement ; les IP des points de terminaison externes doivent être routables publiquement lorsque
...
si l'attribution de tunnel du SOC le prend en charge.
:::
...
flowchart LR
    ...
    subgraph DC["Centre de données xDC_NAMEx"]
        subgraph BIGIPA["BIG-IP-A<br/>xBIGIP_A_OUTER_V4x<br/>xBIGIP_A_OUTER_V6x"]
            T1_INNER["C1-T1 Interne<br/>xBIGIP_C1_T1_INNER_V4x<br/>xBIGIP_C1_T1_INNER_V6x"]
            T2_INNER["C2-T1 Interne<br/>xBIGIP_C2_T1_INNER_V4x<br/>xBIGIP_C2_T1_INNER_V6x"]
        end

        subgraph BIGIPB["BIG-IP-B<br/>xBIGIP_B_OUTER_V4x<br/>xBIGIP_B_OUTER_V6x"]
            T3_INNER["C1-T2 Interne<br/>xBIGIP_C1_T2_INNER_V4x<br/>xBIGIP_C1_T2_INNER_V6x"]
            T4_INNER["C2-T2 Interne<br/>xBIGIP_C2_T2_INNER_V4x<br/>xBIGIP_C2_T2_INNER_V6x"]
        end
    end
