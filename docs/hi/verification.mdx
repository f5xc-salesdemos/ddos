...
title: सत्यापन
description: >-
  BIG-IP पर GRE टनल और BGP कॉन्फ़िगरेशन का सत्यापन करें, और सामान्य समस्याओं का
  निवारण करें।
sidebar:
  order: 6
i18n:
...
1. प्रत्येक HA यूनिट पर, सत्यापित करें कि उस यूनिट की अपनी टनल चालू हैं और
   उसके अपने BGP नेबर कॉन्फ़िगर हैं (दूसरी यूनिट के नहीं)।
:::
...
- हमले का विवरण और स्क्रबिंग कार्रवाइयाँ।
